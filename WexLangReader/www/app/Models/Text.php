...
class Text extends Model
{
    ...
    public function getMyWordsInThisText()
    {
        ...
        $cleanWordsChunked = array_chunk($textWordsClean, 500);

        $allMyWords = new Collection();

        foreach ($cleanWordsChunked as $wordsArray) {

            $wordsFromDb = Word::whereIn('word', $wordsArray)->get();

            $allMyWords = $wordsFromDb->merge($allMyWords);
           // dd($allMyWords);
        }
